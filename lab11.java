...
class lab11
{
    public static void main(String args[])
    {
      ...
      /*  System.out.println("\n Child Thread One Priority = "+m1.t.getPriority());
        System.out.println("\n Child Thread Two Priority = "+m2.t.getPriority());
        System.out.println("\n Child Thread Three Priority = "+m3.t.getPriority());
        System.out.println("\n Child Thread Four Priority = "+m4.t.getPriority());
        System.out.println("\n Child Thread Five Priority = "+m5.t.getPriority());*/
